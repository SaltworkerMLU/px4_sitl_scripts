...
data2 = df2['/fmu/out/vehicle_odometry/position[2]'].values[5830:6830]
...
data1 = df1['/fmu/out/vehicle_odometry/position[2]'].values[12230:13230]
...
plt.plot(t, -data1 - 20*np.ones(len(data1)))
plt.plot(t, -data2- 1*np.ones(len(data1)))
